...
set key noopaque
unset label
set label 1 "0.69 match at t0=35ns" at 4.00000, 300.000, 0.00000 left norotate back nopoint
unset arrow
...
set xrange [ 2.00000 : 5.00000 ] noreverse writeback
...
plot sumhist4 lw 2 lc rgb 'red' title '100V ATI',sumhist lw 2 title '70V ATI',sumhist4 u ($1-log(.69)):($2/2) lc rgb 'red' title '100V ATI scaled py .69'
#    EOF
